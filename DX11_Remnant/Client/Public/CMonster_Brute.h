...
class CMonster_Brute final
	: public CCharacter
{
private :
	CMonster_Brute(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
	CMonster_Brute(const CMonster_Brute& _Prototype);
	virtual ~CMonster_Brute() = default;
...
public :
	static CMonster_Brute* Create(ID3D11Device* _pDevice, ID3D11DeviceContext* _pContext);
